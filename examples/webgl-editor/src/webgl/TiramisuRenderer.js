export class TiramisuRenderer {
    constructor(canvas, config = {}) {
        ...
        this.defaultShaderId = 'passthrough';
        this.canvas = canvas;
    ...
    createFramebuffers() {
        ...
        for (let i = 0; i < 2; i++) {
            ...
            gl.framebufferTexture2D(gl.FRAMEBUFFER, gl.COLOR_ATTACHMENT0, gl.TEXTURE_2D, this.frameTextures[i], 0);
        }
        // Clean up bindings
    ...
    createDefaultShaders() {
        ...
        `;
        this.createShaderProgram(this.defaultShaderId, vertexShaderSource, fragmentShaderSource);
    }
    ...
    createTexture(width, height) {
        ...
        gl.texImage2D(gl.TEXTURE_2D, 0, gl.RGBA, width || this.width, height || this.height, 0, gl.RGBA, gl.UNSIGNED_BYTE, null);
        gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_MIN_FILTER, gl.LINEAR);
        gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_MAG_FILTER, gl.LINEAR);
        gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_WRAP_S, gl.CLAMP_TO_EDGE);
        gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_WRAP_T, gl.CLAMP_TO_EDGE);
