...
export class AudioAnalyzer {
    public async analyze(
        ...
        let AudioVisualizer;
        try {
            // Note the .js extension. This file is generated by wasm-bindgen in your build script
            // @ts-ignore
            ...
            console.warn(
                "Ensure you have Rust installed and 'bun install' ran successfully.",
            );
        ...
        if (totalLength === 0)
            return Array(totalFrames).fill({
                rms: 0,
                bands: Array(BANDS_COUNT).fill(0),
            });
